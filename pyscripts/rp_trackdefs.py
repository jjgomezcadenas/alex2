...
num_tracks = 6570;     # number of tracks to generate and/or fit

chi2_low = 1.0e-5;     # lower chi2 boundary for certain chi2 analyses
chi2_outlier = 100.;     # upper chi2 boundary for chi2 profile and other analyses
...
prof_name = "set";  # name of run used to generate the profiles (only relevant if running fitprof.py)
