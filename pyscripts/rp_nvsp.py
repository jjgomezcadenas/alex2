...
fnb_trkL = "{0}/{1}{2}H_lowerr_b30/trk".format(dat_outdir,base_name,Bfield);
fnb_trkH = "{0}/{1}{2}H_lowerr_b30_sgn/trk".format(dat_outdir,base_name,Bfield);
plt_base = "{0}/{1}{2}H_lowerr_b30/plt".format(dat_outdir,base_name,Bfield);
...
for ntrk in range(num_tracks):
    ...
    if(not os.path.isfile("{0}/{1}{2}H_lowerr_b30/trk/{3}{4}H_lowerr_b30_f{5}.dat".format(dat_outdir,base_name,Bfield,base_name,Bfield,ntrk)) or not os.path.isfile("{0}/{1}{2}H_lowerr_b30_sgn/trk/{3}{4}H_lowerr_b30_sgn_f{5}.dat".format(dat_outdir,base_name,Bfield,base_name,Bfield,ntrk))):
      continue;
    ...
    if(rev_trk):
        ltrktbl = np.loadtxt("{0}/{1}{2}H_lowerr_b30/trk/{3}{4}H_lowerr_b30_r{5}.dat".format(dat_outdir,base_name,Bfield,base_name,Bfield,ntrk));
    else:
        ltrktbl = np.loadtxt("{0}/{1}{2}H_lowerr_b30/trk/{3}{4}H_lowerr_b30_f{5}.dat".format(dat_outdir,base_name,Bfield,base_name,Bfield,ntrk));
    ltrk_node = ltrktbl[:,0];
    ltrk_xM = ltrktbl[:,1];
    ltrk_yM = ltrktbl[:,2];
    ltrk_zM = ltrktbl[:,3];
    ...
    # xM yM zM xP yP zP chi2P xF yF zF chi2F
    if(rev_trk):
        htrktbl = np.loadtxt("{0}/{1}{2}H_lowerr_b30_sgn/trk/{3}{4}H_lowerr_b30_sgn_r{5}.dat".format(dat_outdir,base_name,Bfield,base_name,Bfield,ntrk));
    else:
        htrktbl = np.loadtxt("{0}/{1}{2}H_lowerr_b30_sgn/trk/{3}{4}H_lowerr_b30_sgn_f{5}.dat".format(dat_outdir,base_name,Bfield,base_name,Bfield,ntrk));
    htrk_node = htrktbl[:,0];
    htrk_xM = htrktbl[:,1];
    htrk_yM = htrktbl[:,2];
    htrk_zM = htrktbl[:,3];
...
plt.xlabel("|pos(data) - pos(helix,correct chg)|");
...
#lnd = plt.legend(loc=1,frameon=False,handletextpad=0);
#plt.axis([0,max(splot_ktot),0,max(splot_fratio)]);
plt.xlabel("|pos(data) - pos(helix,incorrect chg)|");
plt.ylabel("Counts/bin");
...
#lnd = plt.legend(loc=1,frameon=False,handletextpad=0);
#plt.axis([0,max(splot_ktot),0,max(splot_fratio)]);
plt.xlabel("|pos(helix,correct chg) - pos(helix,incorrect chg)|");
plt.ylabel("Counts/bin");
...
#lnd = plt.legend(loc=1,frameon=False,handletextpad=0);
#plt.axis([0,max(splot_ktot),0,max(splot_fratio)]);
plt.xlabel("filtered |pos(helix,correct chg) - pos(helix,incorrect chg)|");
plt.ylabel("Counts/bin");
...
plt.title("|data - helix,incorrect chg| profile");
lnd = plt.legend(loc=1,frameon=False,handletextpad=0); # loc=4 is bottom-right of plot
plt.xlabel("Fraction of track fit");
plt.ylabel("|pos(data) - pos(helix,incorrect chg)| average");
...
plt.title("|helix,correct chg - helix,incorrect chg| profile");
lnd = plt.legend(loc=1,frameon=False,handletextpad=0); # loc=4 is bottom-right of plot
plt.xlabel("Fraction of track fit");
plt.ylabel("|pos(helix,correct chg) - pos(helix,incorrect chg)| average");
...
plt.title("filtered |helix,correct chg - helix,incorrect chg| profile");
lnd = plt.legend(loc=1,frameon=False,handletextpad=0); # loc=4 is bottom-right of plot
plt.xlabel("Fraction of track fit");
plt.ylabel("filtered |pos(helix,correct chg) - pos(helix,incorrect chg)| average");
